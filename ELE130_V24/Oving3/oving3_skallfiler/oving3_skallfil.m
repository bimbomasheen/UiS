...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
% Kontinuerlig tid og analytiske uttrykk. 
% Liten verdi på "delta_t" gir tilnærmet kontinuerlig tid.
...
% analytiske uttrykkene er tidskontinuerlige som u(t), y(t) og v(t).
...
figure
set(gcf,'Position',[300 500 600 700])
subplot(3,1,1)
plot(.., y_t, 'b-')    % analytisk uttrykk
hold on
plot(.., y_EulerF, 'b:o')
plot(.. y_EulerB, 'b:v')
